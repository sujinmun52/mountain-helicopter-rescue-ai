...
# 🎯 이번 학습에 완벽히 필수적인 컬럼만 선별 지정하여 디스크 I/O 절약
load_columns = feature_columns + [target_column, 'is_train_final', 'is_test']

# 🎯 pyarrow 엔진과 usecols 옵션을 결합하여 데이터 로드 병목 해결
df = pd.read_csv(
    r'RF_Model\dataset\processed_seoraksan_master.csv', 
    engine='pyarrow', 
