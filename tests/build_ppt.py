...
# ════════ S9 인사이트③ 동적 기상 ════════
s = slide(); header(s, 9, "인사이트 ③ 동적 기상 반영", "통찰")
bullets(s, [
    (0, "같은 조난자라도 실시간 풍속·풍향에 따라 위험·착륙지가 변동", FOREST),
    (0, "고도보정(멱법칙): 지상 풍속 → 헬기 운용고도 환산", FOREST),
    (1, "저지대 잔잔해도 고지대 강풍 반영", None),
    (0, "기종별 운용 풍속 제한: 소형 10 / 대형 20 m/s", FOREST),
    (1, "근거: 항공안전법 시행규칙 제175조 별표24", None),
], 0.6, 1.6, 12, 3.6, 17)
